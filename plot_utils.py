...
class plot:
    def __init__(self, width, height):
        self.width = width #output[0][0].shape[0]
        self.height = height #output[0][0].shape[1]
    def save_frame(self, output, filename):
        
        x1 = output[0][0].view(1, self.width, self.height)
        x1 = x1.permute(1, 2, 0)
        x1 = x1.cpu()
        x1 = x1.detach().numpy()
        plt.figure(1)
    ...
    def save_sequences(self, data, video, output, filename):
        
        figure = plt.figure(figsize=(7, 7))
        figure.add_subplot(2, 4, 1)
        frame0 = data[0][video].view(1, self.width, self.height)
        ...
        frame1 = data[5][video].view(1,self.width,self.height)
        ...
        frame2 = data[10][video].view(1,self.width,self.height)
        ...
        frame3 = data[19][video].view(1,self.width,self.height)
        ...
        frame4 = output[0][video].view(1, self.width, self.height)
        ...
        frame5 = output[5][video].view(1, self.width, self.height)
        ...
        frame6 = output[10][video].view(1, self.width, self.height)
        ...
        frame7 = output[19][video].view(1, self.width, self.height)
